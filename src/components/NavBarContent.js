...
var NavBarContent = React.createClass({
 ...
 // 0.13开始 react ES6不支持mixins
 // 建议使用Higher-order Components
 // 但是tweenState没有修改，所以还是用React.createClass
  ...
  render() {
    ...
    return (
      <View style={[styles.navbar, this.props.headerStyle,this.props.route.headerStyle, transitionStyle]}>
        {leftCorner}
        {titleComponent}
        {rightCorner}
      </View>
